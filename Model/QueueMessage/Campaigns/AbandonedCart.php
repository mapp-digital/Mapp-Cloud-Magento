...
class AbandonedCart
{
    ...
    public function processMessage(string $jsonData): void
    {
        try {
            ...
            $this->mappCombinedLogger->info('MappConnect: -- Product Abandoned cart Sync Consumer -- Sending Product SKU to Mapp: ' . ($messageData['sku'] ?? ($messageData['productSKU'] ?? null)), __CLASS__, __FUNCTION__);
